...
<body>
    <second>
        ...
        <hr class="rounded">
        <br/>
        <span class="entries form2"><i class="fas fa-book"></i> Book title:</span> ${param.title}<br/><span class="entries"><i class="fas fa-pencil-alt padthis "></i> Author:</span> ${param.author}<br/> <span class="entries"><i class="fas fa-barcode padthis "></i> ISBN-10:</span>        ${param.ISBN10}
        <br/> <span class="entries form"><i class="fas fa-barcode padthis "></i> ISBN-13:</span> ${param.ISBN13}
        <br/><br/>
        <hr class="rounded"><br/>
